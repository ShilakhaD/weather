...
function (_React$Component) {
  ...
  function DataTable(props) {
    ...
    _this.state = (0, _getDerivedStateFromProps.default)(props, {});
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "getHeaderProps", {
    ...
    value: function value(_ref) {
      ...
      return _extends({}, rest, {
        ...
        // handler
        onClick: (0, _events.composeEventHandlers)([_this3.handleSortBy(header.key), onClick])
      });
    }
  });
  Object.defineProperty(this, "getRowProps", {
    ...
    value: function value(_ref2) {
      ...
      return _extends({}, rest, {
        ...
        // Compose the event handlers so we don't overwrite a consumer's `onClick`
        // handler
        onExpand: (0, _events.composeEventHandlers)([_this3.handleOnExpandRow(row.id), onClick]),
    ...
    value: function value() {
      ...
      if (row) {
        ...
        return _extends({}, rest, {
          ...
          onSelect: (0, _events.composeEventHandlers)([_this3.handleOnSelectRow(row.id), onClick]),
      ...
      return _extends({}, rest, {
        ...
        name: 'select-all',
        onSelect: (0, _events.composeEventHandlers)([_this3.handleSelectAll, onClick])
      });
    }
  });
  ...
  Object.defineProperty(this, "handleSortBy", {
    ...
    value: function value(headerKey) {
      return function () {
        _this3.setState(function (state) {
          return (0, _sorting.getNextSortState)(_this3.props, state, {
            key: headerKey
          });
        });
      };
