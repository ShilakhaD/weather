  ...
  var Tooltip = function (_mixin) {
    ...
    _createClass(Tooltip, [{
      ...
      value: function createdByEvent(event) {
        ...
        this._debouncedHandleClick({ relatedTarget: relatedTarget, type: type, details: (0, _getLaunchingDetails2.default)(event) });
      }
    }, {
      key: 'changeState',
      ...
      value: function _hookOn(element) {
        ...
        ['focus', 'blur', 'touchleave', 'touchcancel'].forEach(function (name) {
          _this2.manage((0, _on2.default)(element, name, function (event) {
            ...
            _this2._debouncedHandleClick({ target: target, type: type, hadContextMenu: hadContextMenu, details: (0, _getLaunchingDetails2.default)(event) });
          }));
        });
      }
    }, {
      ...
      value: function _handleClick(_ref2) {
        ...
        if (type === 'blur') {
          ...
          var wentToSelf = target && this.element.contains && this.element.contains(target) || this.tooltip.element.contains(target);
