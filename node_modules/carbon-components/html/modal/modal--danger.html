<button class="bx--btn bx--btn--danger--primary" type="button" data-modal-target="#modal-r3cc3bwdh3c">Show modal</button>

<div data-modal id="modal-r3cc3bwdh3c" class="bx--modal bx--modal--danger" tabindex="-1">
