<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-l0j4fzzmd9g">Show modal</button>

<div data-modal id="modal-l0j4fzzmd9g" class="bx--modal " tabindex="-1">
