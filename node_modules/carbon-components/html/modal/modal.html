<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-mtwti0jah8">Show modal</button>

<div data-modal id="modal-mtwti0jah8" class="bx--modal " tabindex="-1">
