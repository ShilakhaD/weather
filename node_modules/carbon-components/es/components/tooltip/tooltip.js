...
var Tooltip = function (_mixin) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function createdByEvent(event) {
      ...
      this._debouncedHandleClick({ relatedTarget: relatedTarget, type: type, details: getLaunchingDetails(event) });
    }
    ...
    value: function _hookOn(element) {
      ...
      ['focus', 'blur', 'touchleave', 'touchcancel'].forEach(function (name) {
        _this2.manage(on(element, name, function (event) {
          ...
          _this2._debouncedHandleClick({ target: target, type: type, hadContextMenu: hadContextMenu, details: getLaunchingDetails(event) });
        }));
      });
    }
